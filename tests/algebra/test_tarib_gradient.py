...
def test_the_headline_stands_far_above_its_matched_null() -> None:
    """+١٫٣٦٨ مقابل +٠٫١٠ = ١٣٫٦٨ ضعفًا؛ والصفريُّ يُسمّى ما طُوبِق عليه."""

    assert rounds_to(HEADLINE / MATCHED_NULL, 2) == Fraction("13.68")
    assert HEADLINE > MATCHED_NULL * 13
