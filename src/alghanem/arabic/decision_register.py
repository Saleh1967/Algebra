...
DECISIONS: Final[tuple[Decision, ...]] = (
    ...
    Decision(
        identifier="ق-4 حركةُ الوقف",
        question=(
            "بأيّ محورٍ تُحدَّد الحركةُ الساقطةُ عند الوقف: الإعرابُ، أم "
            "الموقعُ على الحافّة اليمنى، أم المحوران معًا؟"
        ),
        blocks=(
            "إعلانُ عددِ الوقف",
            "قراءةُ الـ٨٤ عددًا صالحًا عند الحوافّ الثلاث بلا تمييز",
        ),
        branches=(
            Branch(
                label="علامةٌ ثنائيّة: بنيويّةٌ أو إعرابيّة",
                what_changes=(
                    "يحمل كلُّ عضوٍ من الأساس وسمًا يُعيّن أتسقط حركتُه عند "
                    "الوقف أم تثبت، والساقطُ هو الإعرابيُّ وحدَه"
                ),
                price=(
                    "تكذّبها «نَصَرَ» في الجدول نفسِه: فتحةٌ بنيويّةٌ تسقط عند "
                    "الوقف؛ فيلزم استثناءٌ مكتوب، والاستثناءُ الأوّل يفتح البابَ "
                    "لغيره"
                ),
            ),
            Branch(
                label="علامةٌ موقعيّة: حافّةٌ يمنى أو داخل",
                what_changes=(
                    "يصير المُسقِطُ الموقعَ لا الإعراب، فتسقط كلُّ حركةٍ على "
                    "الحافّة اليمنى بنيويّةً كانت أو إعرابيّة"
                ),
                price=(
                    "يسقط تمييزُ البنيويّ من الإعرابيّ رأسًا، فلا يبقى في الجبر "
                    "أثرٌ لفرق الإعراب عن البنية وإن كان الفرقُ قائمًا في العربيّة"
                ),
            ),
            Branch(
                label="محوران مستقلّان: (بنيويّ/إعرابيّ) × (حافّة/داخل)",
                what_changes=(
                    "يستوعب «نَصَرَ» وغيرَها بلا استثناءٍ مكتوب، ويصير سلوكُ "
                    "الوقف دالّةً في المحورين معًا"
                ),
                price=(
                    "يتضاعف فضاءُ الوسم أربعًا، فيحتاج كلُّ منزلةٍ شاهدًا قبل "
                    "أن تُعَدّ — وأكثرُها بلا شاهدٍ اليوم"
                ),
            ),
            Branch(
                label="لا تمييز: الوقفُ إخلاءٌ شامل",
                what_changes="تُخلى الحركةُ الأخيرةُ في كلّ حالٍ بلا وسمٍ إضافيّ",
                price=(
                    "يصير «عددُ الوقف» عددًا واحدًا لا يفرّق بين ما فُقِد وما "
                    "بقي، فيُقرأ فقدُ المعلومة صفرًا"
                ),
            ),
        ),
        note=(
            "الوقفُ فقدُ معلومةٍ لا إعادةَ تصنيف، بخلاف الابتداء؛ ولذلك لا "
            "يُخرَج عددُه قبل الحسم. و«نَصَرَ» شاهدٌ مُقيَّدٌ على أنّ الثنائيّةَ "
            "وحدَها لا تكفي، وهو الذي ولّد الفرعَ الثالث"
        ),
    ),
)
