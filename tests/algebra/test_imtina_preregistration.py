...
def test_the_four_way_score_of_the_current_system_is_arithmetic_too() -> None:
    """**مسحوبةٌ بعد التشغيل** — انظر `test_harf_measurement`.

    ٣٨٫٢٥٪ صحّت تحت «لم يُحسَم = خطأ» (المقيسُ ٣٧٫٨٧٪) وسقطت تحت «= لا إعراب»
    (المقيسُ ٥٨٫٤٣٪). وعطبُ الحساب أنّي بنيتُه على **أربعة** مخارجَ بينما
    أُثبِت في هذا الملفّ نفسِه أنّ المخارجَ خمسة. فليست (ب) «حسابًا» بل
    **غيرَ محكومةٍ لانعدام سياسةٍ مُعلَنة**. ويبقى ما تحته مفحوصًا لأنّ
    الحسابَ نفسَه صحيحٌ تحت سياسةٍ واحدة، والخطأُ في تسميته حتميًّا.
    """
