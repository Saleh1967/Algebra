...
FELL_WITH_THEM: dict[str, str] = {
    "خ٢": "العددَ المعروضَ على تعريفي للعلامة الأخيرة",
    "خ٣": "العددَ المعروضَ للتنوين عند الخاتمة",
    "خ٤": "العددَ المعروضَ عند خاتمة الكلمة — وقد",
    "خ٥": "العددَ المعروضَ للتنوين عند خاتمة الكلمة",
    "خ٦": "العددَ المعروضَ — وهو رهنُ عدد الأصناف، فقد",
    "خ٧": "العددَ المعروضَ عند خاتمة الكلمة",
    "خ١١": "العددَ المعروضَ: أربعٌ لا خمس. وتعريفي",
    "خ١٢": "العددَ المعروضَ على الفصل بالفراغ بعد إزالة",
    "خ١٣": "العددَ المعروضَ لِما تعمى عنه بوّابةُ صاحب",
}
